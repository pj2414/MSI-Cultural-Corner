...
const HomePage = () => {
  ...
  const culturalHeads = [
    ...
    { name: "Jigyaasa", title: "Cultural Head", image: jigisha, description: "Innovative thinker who transforms ideas into memorable experiences.", achievements: ["Innovation Award", "Best Event Planner"], specialty: "Event Innovation" },
